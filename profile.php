...
<body>
    ...
    <div class="container">
        <div class="panel panel-warning" style="margin:0 auto;width: 500px; margin-top: 20px; margin-bottom: 20px;">
            <div class="breadcrumb text-center">แก้ไขข้อมูลส่วนตัว</div>
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="address" id="address" cols="5" class="form-control" rows="5" placeholder="ที่อยู่ปัจจุบัน" required><?php echo $profile['address']; ?></textarea>
                </div>
                <div class="form-group">
                    <label for="tel">เบอร์โทร</label>
                    <input type="text" name="tel" pattern="[0-9]{10}" placeholder="เบอร์โทร (08X-XXX-XXXX)" required class="form-control" value="<?php echo $profile['tel']; ?>" id="tel">
                </div>
            </div>
            <div class="panel-footer text-center">
                <a href="reset_password.php" class="btn btn-info">เปลื่ยนรหัสผ่าน</a>
                <input type="submit" class="btn btn-success" name="register" onclick="return confirm('คุณต้องการที่จะแก้ไขข้อมูลส่วนตัว ?');" value="แก้ไขข้อมูลส่วนตัว">
