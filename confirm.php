...
<body>
    <div class="container">
        <div class="panel panel-warning" style="margin-top:20px">
            <div class="breadcrumb text-center">รายการสั่งซื้อ</div>
        ...
        <div class="panel panel-warning" style="margin:0 auto; width:500px; margin-bottom:20px;">
        <div class="breadcrumb text-center">ข้อมูลผู้รับ</div>
        <div class="panel-body">
        <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="address" id="address" cols="5" class="form-control" rows="5" placeholder="ที่อยู่ปัจจุบัน" required><?php echo$user['address']; ?></textarea>
                </div>
                <div class="form-group">
                    <label for="tel">เบอร์โทร</label>
                    <input type="text" name="tel" pattern="[0-9]{10}" placeholder="เบอร์โทร (08X-XXX-XXXX)" value="<?php echo$user['tel']; ?>" required class="form-control" id="tel">
                </div>
        </div>
        <div class="panel-footer text-center">
            <input type="submit" onclick="return confirm('คุณต้องการสั่งซื้อ ?');" class="btn btn-success" name="submit" value="ยืนยันการสั่งซื้อ">
