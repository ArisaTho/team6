...
<body>
    ...
    <div class="container">
        ...
        <div class="col-lg-3">
            ...
            <button class="btn btn-warning btn-block"><span class="glyphicon glyphicon-search"></span></button>
        </form>
        </div>
        <div class="col-lg-12">
            <div class="panel panel-warning" style="margin-top: 10px;">
                <div class="breadcrumb text-center">รายชื่อสมาชิก</div>
                <table class="table table-hover">
                    ...
                    <td>
                        ...
                        <td>
                            <a href="admin_order.php?id=<?php echo $product['id_order'];?>" onclick="return confirm('คุณต้องการลบชื่อผู้ใช้นี้ ?')" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
