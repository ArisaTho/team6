...
<body>
    <div class="contanier">
        <div class="panel panel-warning" style="margin: 0 auto; width: 500px; margin-top: 50px;">
            <div class="breadcrumb text-center">แก้ไขรายการสินค้า</div>
            ...
            <div class="panel-footer text-center">
                    ...
                    <input type="submit" class="btn btn-success" value="แก้ไขรายการสินค้า" name="add" id="add" onclick="return confirm('คุณต้องการแก้ไขรายการสินค้า ?')">
                </form>
            </div>
        </div>
