        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                    ...
                    <div class="panel panel-warning" style="margin-top: 20px;">
                        <div class="breadcrumb"><?php echo $product['name_product']; ?></div>
                    ...
                    <div class="panel panel-warning" style="margin-top: 20px;">
                        <div class="breadcrumb text-center">แสดงความคิดเห็น</div>
                        <div class="panel-body">
                    ...
                    ?>
                    <div class="panel panel-warning" style="margin-top: 20px;">
                        <div class="breadcrumb">คุณ | <?php echo $comment['firstname'].' '.$comment['lastname']; ?> 
