    ...
    if(isset($_POST['login']))
    {
        ...
        if()
        {
            ...
            if($check->num_rows == 1)
            {
                ...
                {
                    alert("เกิดข้อผิดพลาดในการเปลื่ยนรหัสผ่าน!","forget_confirm.php?id=".$username);
                }
            }
            else
            {
                alert("หมายเลขไม่ถูกต้อง!","forget_confirm.php?id=".$username);
            }
        }
        else
        {
            alert("รหัสผ่านไม่ตรงกัน!","forget_confirm.php?id=".$username);
