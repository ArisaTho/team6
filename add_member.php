...
<body>
    ...
    <div class="container">
        <div class="panel panel-warning" style="margin:0 auto;width: 500px; margin-top: 20px; margin-bottom: 20px;">
            <div class="breadcrumb text-center">เพิ่มสมาชิก</div>
            ...
            <div class="panel-footer text-center">
                <input type="submit" class="btn btn-success" name="register" onclick="return confirm('คุณต้องการที่จะเพิ่มสมาชิก ?');" value="เพิ่มสมาชิก">
