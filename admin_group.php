...
<body>
    ...
    <div class="container">
        <div class="text-right" style="margin-top: 10px;">
            <a href="add_group.php" class="btn btn-warning">เพิ่มหมวดหมู่</a>
        ...
        <div class="col-lg-12">
            <div class="panel panel-warning" style="margin-top: 10px;">
                <div class="breadcrumb text-center">ยี่ห้อรถ</div>
                <table class="table table-hover">
                    <tr>
                        <th class="text-center">ลำดับ</th>
                        <th class="text-center" >ชื่อยี่ห้อรถ</th>
                    ...
                    <tr class="text-center">
                        <td><?php echo $product['id_group'];?></td>
