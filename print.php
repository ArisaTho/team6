...
<body onload="window.print();">
    ...
    <div class="container">
        <div class="text-center" style="margin-top:20px; margin-bottom:20px;">
            <img src="Images/UI/1logo.png" width="500" height="300" alt="No Image">
        </div>
        <h1 class="text-center">ใบเสร็จสั่งซื้อ</h1>
    


        <div class="panel panel-warning">
                               <div class="breadcrumb">หมายเลขสั่งซื้อ: <?php echo $id_order; ?></div>
