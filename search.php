        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                    ...
                    <div class="panel panel-warning" style="margin-top: 20px;">
                        <div class="breadcrumb">สินค้าทั้งหมด</div>
                        <div class="panel-body">
                            <div style="margin: 20px;" class="text-center">
                                <div class="btn-group">
                                    <a href="search.php?search=<?php echo $search?>&mode=h-s" class="btn btn-warning">จากราคามากมาน้อย</a>
                                    <a href="search.php?search=<?php echo $search?>&mode=hot" class="btn btn-warning">ยอดนิยม</a>
                                    <a href="search.php?search=<?php echo $search?>&mode=s-h" class="btn btn-warning">จากราคาน้อยมามาก</a>
                                </div>
                            </div>
                            <?php
                            if($mode == 'h-s')
